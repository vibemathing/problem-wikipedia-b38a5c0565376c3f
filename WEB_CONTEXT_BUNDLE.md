...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-b38a5c0565376c3f",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-b38a5c0565376c3f",
    ...
    "statement": {
      "language": "en",
      "text": "Finding a function to model n-step self-avoiding walks",
      "version": 1
    },
    "title": "Finding a function to model n-step self-avoiding walks",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "03edf7c0da54791800ae9c5a048b7093bfbd206406ec38f8074f316173f26c57"
}
```
